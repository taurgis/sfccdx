 ...
 * @param {boolean} save Whether to save the definition to a file
 */
async function processSingleGroup(systemObjectDefinition, object, attributeGroup, save) {
...
module.exports = (commandProgram) => {
    commandProgram
        ...
        .option(
            '-s, --save',
            'Save the Attribute Group definition to the data folder. (Possibly for CI purposes or backup).',
            false,
        )
        .option(
            '-o, --object <object>',
                ...
                for (let i = 0; i < objectIDs.length; i++) {
                    ...
                    // eslint-disable-next-line no-await-in-loop
                        await processSingleGroup(
                            systemObjectDefinition, modifiedOptions.object, modifiedOptions.attributeGroup, modifiedOptions.save
                        );
                    } else {
                        ...
                        if (attributeGroupIDs.length > 0) {
                            for (let attributeGroupID of attributeGroupIDs) {
                                await processSingleGroup(systemObjectDefinition, modifiedOptions.object, attributeGroupID, modifiedOptions.save);
                            };
                        }
                    }
                }
