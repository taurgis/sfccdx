 ...
 */
async function processSingleAttribute(systemObjectDefinition, object, attribute, save) {
...
module.exports = (commandProgram) => {
    commandProgram
        ...
        .option(
            '-s, --save',
            'Save the attribute definition to the data folder. (Possibly for CI purposes or backup).',
            false,
        )
        .option(
            '-o, --object <object>',
                ...
                for (let i = 0; i < objectIDs.length; i++) {
                    ...
                    // eslint-disable-next-line no-await-in-loop
                        await processSingleAttribute(
                            systemObjectDefinition, modifiedOptions.object, modifiedOptions.attribute, modifiedOptions.save
                        );
                    } else {
                    // eslint-disable-next-line no-await-in-loop
                        ...
                        // eslint-disable-next-line no-await-in-loop
                            await processSingleAttribute(systemObjectDefinition, modifiedOptions.object, attributeID, modifiedOptions.save);
                        }
                    }
                }
